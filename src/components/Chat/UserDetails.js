  ...
  return (
    ...
    >
      ...
      >
        ...
        <IoCloseOutline onClick={() => setDetailIsVisible(false)} />
      </div>
      <div className={styles.user_details}>
        ...
        <h3
          className={`${styles.user_name} ${theme === "dark" ? styles.user_name_dark : ""
            }`}
        >
      ...
      <div className={styles.communication_tools}>
        <div
          className={`${styles.contact} ${theme === "dark" ? styles.contact_dark : ""
            }`}
        >
          <FiVideo />
          <div>Video</div>
